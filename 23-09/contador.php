        ...
        <div id="timer">
            ...
            <div id="countdown">
                ...
                <div id="title">
                    ...
                    <div class="title" style="position: absolute; top: 36px; left: 105px">'.$l[1].'</div>
                    <div class="title" style="position: absolute; top: 36px; left: 156px">'.$l[2].'</div>
                    <div class="title" style="position: absolute; top: 36px; left: 211px">'.$l[3].'</div>
                </div>
            </div>
        </div>
    </div>
